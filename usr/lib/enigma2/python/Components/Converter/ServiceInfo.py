# Embedded file name: /usr/lib/enigma2/python/Components/Converter/ServiceInfo.py
...
class ServiceInfo(Converter, object):
    ...
    def __init__(self, type):
        ...
        self.type, self.interesting_events = {'HasTelext': (self.HAS_TELETEXT, (iPlayableService.evUpdatedInfo,)),
         ...
         'IsSDAndNotWidescreen': (self.IS_SD_AND_NOT_WIDESCREEN, (iPlayableService.evVideoSizeChanged,))}[type]
